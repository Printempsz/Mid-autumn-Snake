...
io.on('connection', function(socket){
  ...
  socket.on('wechat', function(url) {
    ...
    var salt = "fas9d876r39q";
    console.log(nickname,openid,verify);
    if(sha1(nickname + ',' + openid + ',' + salt) == verify) {
      console.log("yes");
      ...
      console.log("no");
      console.log(nickname);
      console.log(sha1(nickname + ',' + openid + ',' + salt));
    }
    // console.log(sha1("张昊岚"+','+"o-K9R0yuTOgXmJvurOu1Sooh8pSg"+','+"fas9d876r39q"))
